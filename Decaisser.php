...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($method === 'UPDATE') {
        ...
        $res = supprimerSortie($_POST['id-to-delete']);
        setSessionMessage($res['status'], $res['message']);
    } else {
        $res = ajouterSortie(
            $_POST['ideglise'],
                ...
                <?php foreach ($data as $d): ?>
                    <tr id="<?php echo htmlspecialchars($d['idsortie']) ?>">
                        ...
                        <td style="text-align: end;padding-right:6px">
                            <?php echo htmlspecialchars($formatter->formatCurrency($d['montantSortie'], 'MGA')); ?>
                        </td>
    ...
    <div id="pop-up-form" class="centered-modal" style="display: none;">
        <div class="wrapper">
            <div class="window-decoration">
                <h4 class="form-title" style="margin-left: auto;">Retirer de la caisse</h4>
            ...
            <form class="form-container" method="POST" action="" autocomplete="off">
                ...
                <input type="hidden" name="ideglise" class="id-eglise"
                    value="<?php echo htmlspecialchars($_SESSION['ID_EGLISE']); ?>" required>
